 ...
 */
@Data
@Component(DEST_MONGO_DB_CONFIG_PROPERTIES)
@ConfigurationProperties(prefix = DEST_MONGO_CONFIG_PREFIX)
@ConditionalOnProperty(
        prefix = APP_BATCH_CONFIG_PREFIX,
        name = DESTINATION_DB,
        havingValue = MONGODB)
@EqualsAndHashCode(callSuper = true)
public class DestMongoDbConfigProperties extends MongoDbConfigProperties {}
